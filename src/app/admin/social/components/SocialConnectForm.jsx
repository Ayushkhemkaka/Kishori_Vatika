...
function SocialConnectForm() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      const res = await fetch("/api/social/connect", {
        ...
        body: JSON.stringify({
          platform,
          pageId: platform === "FACEBOOK" ? pageId : void 0,
          accountId: platform === "INSTAGRAM" ? accountId : void 0,
          accessToken
        })
      });
  ...
  return <form onSubmit={handleSubmit} className="space-y-4 rounded-xl border border-white/10 bg-slate-900/60 p-6">
