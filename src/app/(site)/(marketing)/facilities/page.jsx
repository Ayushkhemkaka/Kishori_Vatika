  ...
  return (
    <div className="space-y-10">
      <header className="space-y-3 text-center sm:text-left">
        <p className="text-[11px] font-medium uppercase tracking-[0.28em] text-emerald-700">Facilities</p>
        ...
        {facilities.map((facility) => (
          ...
          >
            ...
            <div className="space-y-5 rounded-3xl border border-emerald-100 bg-white p-6">
              ...
              <h2 className="font-display text-4xl font-normal tracking-tight text-stone-900">{facility.title}</h2>
