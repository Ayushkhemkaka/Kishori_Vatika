...
const metadata = {
  title: "Offers",
  description: "Curated stay packages with dining, experiences, and event options at Kishori Vatika."
};
...
async function OffersPage() {
  ...
  >
      ...
      {offers.length > 0 ? <section className="grid gap-5 md:grid-cols-2">
  ...
  >
        ...
        </section> : <div className="rounded-2xl border border-emerald-100 bg-white p-8 text-center">
