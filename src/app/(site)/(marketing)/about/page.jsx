...
const metadata = {
  title: "About",
  description: "Learn about Kishori Vatika, our rooms, dining, and event spaces designed for elegant stays."
};
const values = [
  {
    title: "Warm hospitality",
    description: "A small team, attentive service, and a calm pace that lets you settle in quickly."
  },
  {
    title: "Boutique comfort",
    description: "Twenty rooms across five categories, with thoughtful layouts and restful interiors."
  },
  {
    title: "Celebrations made easy",
    description: "One banquet and one small hall supported by a focused, experienced events team."
  }
];
  ...
  return <div className="space-y-12">
      <header className="space-y-4">
        ...
        <div className="flex flex-wrap gap-3 text-xs text-emerald-700">
          {propertyHighlights.map((item) => <span
    key={item}
